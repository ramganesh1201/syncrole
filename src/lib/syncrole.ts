...
export const ACHIEVEMENT_CATALOG: Record<string, { name: string; desc: string; emoji: string }> = {
  first_login: { name: "First Login", desc: "Welcome to SyncRole", emoji: "🎉" },
  profile_completed: { name: "Profile Complete", desc: "100% profile completion", emoji: "✅" },
  resume_uploaded: { name: "Resume Uploaded", desc: "First resume analyzed", emoji: "📄" },
  github_connected: { name: "GitHub Connected", desc: "Code analyzed", emoji: "🐙" },
  dsa_10: { name: "DSA Beginner", desc: "10 problems solved", emoji: "🧩" },
  dsa_50: { name: "DSA Pro", desc: "50 problems solved", emoji: "⚡" },
  dsa_100: { name: "DSA Master", desc: "100 problems solved", emoji: "🏆" },
  streak_7: { name: "On Fire", desc: "7-day streak", emoji: "🔥" },
  streak_30: { name: "Unstoppable", desc: "30-day streak", emoji: "💎" },
  resume_85: { name: "Polished Resume", desc: "Resume score ≥ 85", emoji: "📝" },
  placement_80: { name: "Placement Ready", desc: "Placement score ≥ 80", emoji: "🚀" },
};
...
export function profileCompletionPct(p: {
